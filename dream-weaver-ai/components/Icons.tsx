...
export const MicrophoneIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75V18.75m0 0H9.75M12 18.75H14.25M12 12.75v-1.5m0 0A3.75 3.75 0 008.25 7.5M12 11.25a3.75 3.75 0 013.75-3.75M8.25 7.5c0-1.02.396-1.944 1.05-2.65M15.75 7.5c0-1.02-.396-1.944-1.05-2.65" />
  </svg>
);
...
export const SendIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
        <path d="M3.105 2.289a.75.75 0 00-.826.95l1.414 4.949a.75.75 0 00.95.534h6.105a.75.75 0 000-1.5H4.99l-1.05-3.674a.75.75 0 00-.835-.765z" />
        <path d="M16.905 8.289a.75.75 0 00-1.026-.826l-8.25 2.357a.75.75 0 000 1.382l8.25 2.357a.75.75 0 001.026-.826l-1.414-4.949z" />
    </svg>
);

export const LoadingSpinnerIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8" }) => (
...
export const StarsIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const NewDreamIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
